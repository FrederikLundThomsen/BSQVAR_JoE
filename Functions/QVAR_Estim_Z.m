...
function [b,q,eps,Zr] = QVAR_Estim_Z(Y,P,X,S,D,theta,i,ZeroRestrictions)
...
if i==1
    ...
    %Linear programming estimator of Koenker and Bassett (1978).
    bz = rq_fnm(Zr, Y((P+1):end,1), theta);
    ...
    bz = rq_fnm(Zr, Y((P+1):end,i), theta);
